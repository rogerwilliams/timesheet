...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        TSMasterViewController *masterViewController = [[[TSMasterViewController alloc] initWithNibName:@"TSMasterViewController_iPhone" bundle:nil] autorelease];
        ...
        TSDetailViewController *detailViewController = [[[TSDetailViewController alloc] initWithNibName:@"TSDetailViewController_iPad" bundle:nil] autorelease];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"iOSTimesheet" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"iOSTimesheet.sqlite"];
